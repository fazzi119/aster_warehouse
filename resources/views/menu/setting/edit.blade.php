        ...
        <div class="row">
            <div class="col-md-8">
                <div class="card card-with-nav">
                        ...
                        <div class="row row-nav-line">
                            <ul class="nav nav-tabs nav-line nav-color-secondary" role="tablist">
                                <li class="nav-item"> <a class="nav-link active show" data-toggle="tab"
                                        href="{{ url('setting') }}" role="tab" aria-selected="true">Data User</a>
                                </li>
                            </ul>
                        </div>
                    ...
                    <div class="card-body">
                        <form action="{{ url('setting/' . $user->id) }}" method="post">
                            @csrf
                            @method('PUT')
                            <div class="row mt-3">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group form-group-default">
                                        ...
                                        <input type="email" class="form-control" value="{{ $user->email }}"
                                            name="email" placeholder="hello@aster.com">
                                    </div>
                                </div>
                            </div>
                            <div class="row mt-3">
