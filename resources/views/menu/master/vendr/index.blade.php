...
@section('konten')
    <div class="page-inner">
        <div class="page-header d-flex justify-content-between">
            ...
            <x-form-search action="{{ url('master/vendor') }}" />
        ...
        <div class="row">
            <div class="col-12">
                    ...
                    <div class="card-header">
                        <div class="d-flex justify-content-between align-items-center">
                            {{-- <div style="display:flex; align-items: center;">
                                <a href="{{ route('vendor-export') }}" class="btn btn-success btn-sm"><i
                                ...
                                <x-modal-import data="{{ $subtitle }}" action="{{ route('vendor-import') }}" />

                            </div> --}}
                            <a href="{{ url('master/vendor/create') }}" class="btn btn-primary btn-sm"><i
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align: center; vertical-align: middle;">
                                                <div style="display: flex; justify-content: center;">
                                                    ...
                                                    <a href="{{ url('master/vendor/' . $item->id . '/edit') }}"
                                                        class="btn btn-warning btn-sm mr-1"><i class="fas fa-edit"></i></a>

                                                    <form action="{{ url('master/vendor/' . $item->id) }}" method="post">
                                                        @method('DELETE')
                                                        @csrf
                                                        <button type="submit"
                ...
                <div class="d-flex justify-content-end mt-3">
                    <p style="margin: 0;">
                        Showing {{ $vendor->firstItem() }} to {{ $vendor->lastItem() }} of {{ $vendor->total() }} entries
                    </p>
                </div>
            </div>
        </div>
