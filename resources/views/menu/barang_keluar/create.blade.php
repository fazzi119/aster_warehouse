                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex justify-content-between align-items-center">
                            <h4 class="card-title">Tambah Kiriman Barang</h4>
                        </div>
                    </div>
                    <div class="card-body">
                        <form action="{{ url('barangkeluar') }}" method="POST" enctype="multipart/form-data">
                            <div class="row">
                                @csrf
                                <div class="col-12">
                                    <div class="form-group form-group-default">
                                        <label for="tanggal">Tanggal Keluar</label>
                                        <input type="date" class="form-control" id="tanggal" name="tgl_keluar">
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="form-group form-group-default">
