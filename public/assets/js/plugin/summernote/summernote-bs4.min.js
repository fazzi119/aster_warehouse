/*! Summernote v0.8.9 | (c) 2013- Alan Hong and other contributors | MIT license */ (function (
  global,
  factory
) {
  ...
  function splitNode(point, options) {
    ...
    if (isText(point.node)) {
      ...
      var clone = insertAfter(point.node.cloneNode(!1), point.node);
  ...
  function posFromPlaceholder(placeholder) {
    ...
    var height = $placeholder.outerHeight(!0);
  ...
  var WrappedRange = (function () {
    ...
    WrappedRange.prototype.normalize = function () {
      ...
      var endPoint = getVisiblePoint(this.getEndPoint(), !1);
      var startPoint = this.isCollapsed()
        ? endPoint
        : getVisiblePoint(this.getStartPoint(), !0);
    ...
    WrappedRange.prototype.deleteContents = function () {
      ...
      var nodes = rng.nodes(null, { fullyContains: !0 });
  ...
  var range = {
    ...
    createFromSelection: function () {
      ...
      if (env.isW3CRangeSupport) {
        ...
        textRangeEnd.collapse(!1);
        var textRangeStart = textRange;
        textRangeStart.collapse(!0);
        var startPoint = textRangeToPoint(textRangeStart, !0);
        var endPoint = textRangeToPoint(textRangeEnd, !1);
        if (
    ...
    createFromNodeBefore: function (node) {
      return this.createFromNode(node).collapse(!0);
    },
  ...
  var Style = (function () {
    ...
    Style.prototype.stylePara = function (rng, styleInfo) {
      $$1.each(
        rng.nodes(dom.isPara, { includeAncestor: !0 }),
        function (idx, para) {
  ...
  var Bullet = (function () {
    ...
    Bullet.prototype.indent = function (editable) {
      ...
      var paras = rng.nodes(dom.isPara, { includeAncestor: !0 });
    ...
    Bullet.prototype.toggleList = function (listName, editable) {
      ...
      if (lists.find(paras, dom.isPurePara)) {
        ...
        if (diffLists.length) {
          ...
          paras = this.releaseList(clustereds, !0);
        }
      }
      ...
      for (var actionIndex = 0; actionIndex < actions.length; actionIndex++) {
        ...
        switch (actions[actionIndex].action) {
          ...
          case TableResultAction.resultAction.SubtractSpanCount:
            ...
            continue;
          case TableResultAction.resultAction.RemoveCell:
            dom.remove(actions[actionIndex].baseCell, !0);
            continue;
        }
      }
    };
  ...
  var Editor = (function () {
    function Editor(context) {
      ...
      for (var idx = 0, len = commands.length; idx < len; idx++) {
        this[commands[idx]] = (function (sCmd) {
          return function (value) {
            _this.beforeCommand();
            document.execCommand(sCmd, !1, value);
            _this.afterCommand(!0);
          };
        })(commands[idx]);
        this.context.memo(
          "help." + commands[idx],
      ...
      this.color = this.wrapCommand(function (colorInfo) {
        ...
        if (foreColor) {
          document.execCommand("foreColor", !1, foreColor);
        }
        if (backColor) {
          document.execCommand("backColor", !1, backColor);
        }
      });
      this.foreColor = this.wrapCommand(function (colorInfo) {
        document.execCommand("styleWithCSS", !1, !0);
        document.execCommand("foreColor", !1, colorInfo);
      });
    ...
    Editor.prototype.handleKeyMap = function (event) {
      ...
      if (eventName) {
        if (this.context.invoke(eventName) !== !1) {
    ...
    Editor.prototype.onFormatBlock = function (tagName, $target) {
      ...
      document.execCommand("FormatBlock", !1, tagName);
  ...
  var Handle = (function () {
    ...
    Handle.prototype.update = function (target) {
      ...
      if (isImage) {
        ...
        var imageSize = { w: $image.outerWidth(!1), h: $image.outerHeight(!1) };
        $selection
          .css({
            display: "block",
            left: pos.left,
  ...
  var Context = (function () {
    ...
    Context.prototype._initialize = function () {
      ...
      Object.keys(modules).forEach(function (key) {
        _this.module(key, modules[key], !0);
      });
